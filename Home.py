...
st.set_page_config(page_title='Real Estate Analytical Module - Home', page_icon="🏠", layout='wide')

# App title
st.title('Welcome to the Real Estate Analytical Module')

# Project Overview
st.header('Project Overview')
st.markdown("""
Welcome to the Real Estate Analytical Module! This project aims to provide comprehensive insights and predictions for real estate properties. The module consists of several key features:

- **Real Estate Price Prediction**: Predict the price of a property based on various features such as property type, sector, number of bedrooms, bathrooms, balconies, property age, built-up area, servant room, store room, furnishing type, luxury category, and floor category.
...
st.header('Real Estate Analytical Tools')
st.markdown("""
...
# Footer
st.markdown("""
**© 2024 Real Estate Analytical Module. All rights reserved.**
""")
